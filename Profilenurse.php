...
<body>
	...
	<center><label style="color: green"><h1>BIG HOSPITAL</h1></label></center>
	<a href="Nurse.php" ><img src="icons/images (4).png" height="60px"></a>
</div>
	<div class="divprofileinfor">
		...
		<label><b><i>position :</i></b></label><label>Nurse</label><br><br>
